...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Come on dont give up!!', 0.4], //From 20% to 39%
		['Collin Is Mad!', 0.5], //From 40% to 49%
		['um', 0.6], //From 50% to 59%
		['uh', 0.69], //From 60% to 68%
		['Wow!', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Good Job!', 0.9], //From 80% to 89%
		['Super!', 1], //From 90% to 99%
		['Collin is Happy!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
